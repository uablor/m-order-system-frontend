...
const MERCHANTS_ENDPOINTS = {
  ...
  UPDATE_ACTIVE: (id: number) => `${MERCHANTS_BASE}/${id}/active`,
...
const EXCHANGE_RATES_ENDPOINTS = {
  ...
  CREATE_FOR_EDIT: `${EXCHANGE_RATES_BASE}/for-edit`,
...
const ORDERS_ENDPOINTS = {
  ...
  PATCH_FULL: (id: number) => `${ORDERS_BASE}/${id}/patch-full`,
